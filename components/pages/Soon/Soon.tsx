    ...
    <div className="bg-slate-900">
      ...
      >
        ...
        <span className="text-lg leading-8 font-extralight mb-12">
          Em breve, você poderá fazer parte da plataforma de empregabilidade
          mais promissora que já surgiu no mercado. Para receber as novidades,
        ...
        >
          ...
          >
            ...
            você para divulgação do andamento do projeto, e está ciente de que
            não compartilharemos seus dados com terceiros em nenhuma hipótese,
            exceto se houver ordem judicial autorização prévia e expressa do
            usuário.
          </span>
          <div className="my-4  ">
            <Label>
